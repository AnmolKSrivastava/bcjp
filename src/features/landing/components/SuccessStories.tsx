...
export function SuccessStories({ lang }: Props) {
  return (
    <section id="stories" className="bg-white py-20 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-14">
          ...
          <p className="text-lg text-[#64748B] max-w-xl mx-auto">
            {lang === "hi"
              ? "हज़ारों मज़दूरों ने KaamSetu से अपनी नई नौकरी पाई"
              : "Thousands of workers found their next job through KaamSetu"}
          </p>
        </div>
          ...
          {stories.map((story, i) => (
            ...
            >
              ...
              <div className="flex gap-1 mb-4">
                {[1, 2, 3, 4, 5].map((s) => (
                  <Star key={s} size={14} fill="#F97316" stroke="none" />
                ))}
              </div>
