...
export function CTABanner({ lang, onCreateProfileClick }: Props) {
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <h2 className="text-4xl sm:text-5xl font-extrabold text-white mb-5 leading-tight">
              {lang === "hi"
                ? "आपकी अगली नौकरी बस एक बातचीत दूर है"
                : "Your Next Job Is One Conversation Away"}
            </h2>
            <p className="text-xl text-blue-100 mb-8 leading-relaxed">
              {lang === "hi"
                ? "अभी बोलें और AI आपका रेज़्यूमे मुफ़्त में बनाए।"
                : "Speak now and let AI create your resume for FREE."}
            </p>
            ...
            <div className="flex flex-wrap gap-6 mt-8 text-blue-100">
              {[
                ...
                <span key={i} className="text-sm font-semibold">{item[lang]}</span>
              ))}
            </div>
          </motion.div>
