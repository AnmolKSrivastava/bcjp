        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 lg:gap-6">
          {industries.map((cat, i) => (
            <Link
              ...
              className="group relative rounded-2xl overflow-hidden shadow-sm border border-[#E2E8F0] hover:shadow-xl hover:-translate-y-2 transition-all duration-300"
            >
              <motion.div
