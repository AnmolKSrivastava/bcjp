...
function EmployerSection({ lang }) {
  ...
  >
            ...
            <p className="text-lg text-[#64748B] mb-8 leading-relaxed">
              {lang === "hi" ? "AI की मदद से सैकड़ों सत्यापित कामगारों तक पहुँचें। वॉयस रेज़्यूमे सुनें और सही उम्मीदवार चुनें।" : "Access thousands of verified blue-collar workers through AI matching. Listen to voice resumes and hire the right candidate."}
            </p>

            <div className="space-y-4 mb-10">
              {features.map((feat, i) => <div key={i} className="flex items-center gap-4 bg-white rounded-2xl p-4 border border-[#E2E8F0] shadow-sm hover:shadow-md transition-shadow">
