...
export function LanguageModal({ onSelect }: Props) {
      ...
      >
        ...
        <div className="flex flex-col gap-4 mb-8">
          <button
            ...
            className={`flex items-center justify-center gap-3 py-4 px-6 rounded-2xl text-xl font-semibold border-2 transition-all duration-200 ${
              selected === "hi"
                ? "bg-[#2563EB] border-[#2563EB] text-white shadow-lg scale-105"
                : "bg-[#F8FAFC] border-[#E2E8F0] text-[#0F172A] hover:border-[#2563EB] hover:bg-blue-50 hover:scale-102"
            }`}
          >
            🇮🇳 <span>हिन्दी</span>
          </button>
          <button
            ...
            className={`flex items-center justify-center gap-3 py-4 px-6 rounded-2xl text-xl font-semibold border-2 transition-all duration-200 ${
              selected === "en"
                ? "bg-[#2563EB] border-[#2563EB] text-white shadow-lg scale-105"
                : "bg-[#F8FAFC] border-[#E2E8F0] text-[#0F172A] hover:border-[#2563EB] hover:bg-blue-50"
            }`}
          >
            🇬🇧 <span>English</span>
          </button>
        ...
        <button
          ...
          className={`w-full py-4 rounded-2xl text-lg font-bold transition-all duration-200 ${
            selected
              ? "bg-[#F97316] text-white hover:bg-orange-500 shadow-lg shadow-orange-200 hover:scale-105"
